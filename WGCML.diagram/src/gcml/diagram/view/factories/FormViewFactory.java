	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = WgcmlVisualIDRegistry
					.getType(FormEditPart.VISUAL_ID);
		...
		getViewService().createNode(eObjectAdapter, view,
				WgcmlVisualIDRegistry.getType(FormActionEditPart.VISUAL_ID),
				ViewUtil.APPEND, true, getPreferencesHint());
		getViewService().createNode(
				eObjectAdapter,
				view,
				WgcmlVisualIDRegistry
						.getType(FormFormDataTypeEditPart.VISUAL_ID),
				ViewUtil.APPEND, true, getPreferencesHint());
		getViewService().createNode(eObjectAdapter, view,
				WgcmlVisualIDRegistry.getType(FormFormNameEditPart.VISUAL_ID),
				ViewUtil.APPEND, true, getPreferencesHint());
		getViewService().createNode(
				eObjectAdapter,
				view,
