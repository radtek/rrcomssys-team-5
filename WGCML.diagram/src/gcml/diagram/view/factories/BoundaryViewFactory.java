 ...
 * @generated
 */
public class BoundaryViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = WgcmlVisualIDRegistry
					.getType(BoundaryEditPart.VISUAL_ID);
		...
		getViewService().createNode(eObjectAdapter, view,
				WgcmlVisualIDRegistry.getType(BoundaryNameEditPart.VISUAL_ID),
				ViewUtil.APPEND, true, getPreferencesHint());
		getViewService().createNode(
				eObjectAdapter,
				view,
				WgcmlVisualIDRegistry
						.getType(BoundaryOutcomeEditPart.VISUAL_ID),
				ViewUtil.APPEND, true, getPreferencesHint());
		getViewService().createNode(eObjectAdapter, view,
				WgcmlVisualIDRegistry.getType(BoundaryTypeEditPart.VISUAL_ID),
				ViewUtil.APPEND, true, getPreferencesHint());
	}
}
