 ...
 * @generated
 */
public class CallToBoundaryReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public CallToBoundaryReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return WgcmlBaseItemSemanticEditPolicy.LinkConstraints
				.canExistCallToBoundary_4013(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return WgcmlBaseItemSemanticEditPolicy.LinkConstraints
				.canExistCallToBoundary_4013(getOldSource(), getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().setToBoundary(null);
		getNewSource().setToBoundary(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().setToBoundary(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
