...
public class DeviceFromIsAttachedReorientCommand extends EditElementCommand {
	...
	protected boolean canReorientSource() {
		...
		return WgcmlBaseItemSemanticEditPolicy.LinkConstraints
				.canExistDeviceFromIsAttached_4003(getNewSource(),
						getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return WgcmlBaseItemSemanticEditPolicy.LinkConstraints
				.canExistDeviceFromIsAttached_4003(getOldSource(),
						getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().setFromIsAttached(null);
		getNewSource().setFromIsAttached(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().setFromIsAttached(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
