 ...
 * @generated
 */
public class DecisionFromDecisionToBoudaryReorientCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public DecisionFromDecisionToBoudaryReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return WgcmlBaseItemSemanticEditPolicy.LinkConstraints
				.canExistDecisionFromDecisionToBoudary_4011(getNewSource(),
						getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return WgcmlBaseItemSemanticEditPolicy.LinkConstraints
				.canExistDecisionFromDecisionToBoudary_4011(getOldSource(),
						getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().setFromDecisionToBoudary(null);
		getNewSource().setFromDecisionToBoudary(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().setFromDecisionToBoudary(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
