 ...
 * @generated
 */
public class FormToConnectionReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public FormToConnectionReorientCommand(
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof Connection && newEnd instanceof Form)) {
			return false;
		}
		return WgcmlBaseItemSemanticEditPolicy.LinkConstraints
				.canExistFormToConnection_4002(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return WgcmlBaseItemSemanticEditPolicy.LinkConstraints
				.canExistFormToConnection_4002(getOldSource(), getNewTarget());
	}
