 ...
 * @generated
 */
public class DecisionFromDecisionReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public DecisionFromDecisionReorientCommand(
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof Call && newEnd instanceof Decision)) {
			return false;
		}
		return WgcmlBaseItemSemanticEditPolicy.LinkConstraints
				.canExistDecisionFromDecision_4012(getNewSource(),
						getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return WgcmlBaseItemSemanticEditPolicy.LinkConstraints
				.canExistDecisionFromDecision_4012(getOldSource(),
						getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().setFromDecision(null);
		getNewSource().setFromDecision(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().setFromDecision(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
