...
public class BoundaryItemProvider
	...
	/**
	 * This adds a property descriptor for the Boundary To Call feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addBoundaryToCallPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Boundary_BoundaryToCall_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Boundary_BoundaryToCall_feature", "_UI_Boundary_type"),
				 GcmlPackage.Literals.BOUNDARY__BOUNDARY_TO_CALL,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((Boundary)object).getActivityID();
