...
public class FormItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addFormDataTypePropertyDescriptor(object);
			addFormNamePropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Form Data Type feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addFormDataTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Form_formDataType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Form_formDataType_feature", "_UI_Form_type"),
				 GcmlPackage.Literals.FORM__FORM_DATA_TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This adds a property descriptor for the Form Name feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addFormNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Form_formName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Form_formName_feature", "_UI_Form_type"),
				 GcmlPackage.Literals.FORM__FORM_NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Form)object).getFormName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Form.class)) {
			...
			case GcmlPackage.FORM__FORM_DATA_TYPE:
			case GcmlPackage.FORM__FORM_NAME:
