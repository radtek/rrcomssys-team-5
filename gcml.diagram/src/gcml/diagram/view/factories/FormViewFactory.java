 ...
 * @generated
 */
public class FormViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = GcmlVisualIDRegistry.getType(FormEditPart.VISUAL_ID);
		...
		getViewService().createNode(eObjectAdapter, view,
				GcmlVisualIDRegistry.getType(FormActionEditPart.VISUAL_ID),
				ViewUtil.APPEND, true, getPreferencesHint());
		getViewService().createNode(
				eObjectAdapter,
				view,
				GcmlVisualIDRegistry
						.getType(FormFormTypeNameEditPart.VISUAL_ID),
				ViewUtil.APPEND, true, getPreferencesHint());
		getViewService().createNode(
				eObjectAdapter,
				view,
				GcmlVisualIDRegistry
						.getType(FormMediumDataTypeEditPart.VISUAL_ID),
				ViewUtil.APPEND, true, getPreferencesHint());
		getViewService().createNode(
				eObjectAdapter,
				view,
				GcmlVisualIDRegistry
						.getType(FormSuggestedApplicationEditPart.VISUAL_ID),
				ViewUtil.APPEND, true, getPreferencesHint());
		getViewService().createNode(
				eObjectAdapter,
				view,
				GcmlVisualIDRegistry
						.getType(FormVoiceCommandEditPart.VISUAL_ID),
				ViewUtil.APPEND, true, getPreferencesHint());
	}
}
