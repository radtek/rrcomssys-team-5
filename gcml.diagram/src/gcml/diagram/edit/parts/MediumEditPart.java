...
public class MediumEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof MediumDerivedFromBuiltInTypeEditPart) {
			((MediumDerivedFromBuiltInTypeEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureMediumDerivedFromBuiltInTypeFigure());
			return true;
		}
		if (childEditPart instanceof MediumMediumTypeNameEditPart) {
			((MediumMediumTypeNameEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureMediumMediumTypeNameFigure());
			return true;
		}
	...
	public class MediumFigure extends RectangleFigure {
		 ...
		 * @generated
		 */
		private WrappingLabel fFigureMediumDerivedFromBuiltInTypeFigure;
		/**
		 * @generated
		 */
		private WrappingLabel fFigureMediumMediumTypeNameFigure;
		/**
		 * @generated
		 */
		...
		private void createContents() {
			...
			fFigureMediumDerivedFromBuiltInTypeFigure = new WrappingLabel();
			fFigureMediumDerivedFromBuiltInTypeFigure.setText("<...>");

			this.add(fFigureMediumDerivedFromBuiltInTypeFigure);

			fFigureMediumMediumTypeNameFigure = new WrappingLabel();
			fFigureMediumMediumTypeNameFigure.setText("<...>");

			this.add(fFigureMediumMediumTypeNameFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureMediumDerivedFromBuiltInTypeFigure() {
			return fFigureMediumDerivedFromBuiltInTypeFigure;
		}

		/**
		 * @generated
		 */
		public WrappingLabel getFigureMediumMediumTypeNameFigure() {
			return fFigureMediumMediumTypeNameFigure;
		}
