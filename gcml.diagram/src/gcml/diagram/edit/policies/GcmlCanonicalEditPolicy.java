 ...
 * @generated
 */
public class GcmlCanonicalEditPolicy extends CanonicalConnectionEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		for (Iterator it = GcmlDiagramUpdater.getGcml_1000SemanticChildren(
	...
	protected Set getFeaturesToSynchronize() {
		if (myFeaturesToSynchronize == null) {
			...
			myFeaturesToSynchronize.add(GcmlPackage.eINSTANCE.getGcml_Device());
			myFeaturesToSynchronize.add(GcmlPackage.eINSTANCE.getGcml_Form());
			myFeaturesToSynchronize.add(GcmlPackage.eINSTANCE.getGcml_Medium());
			myFeaturesToSynchronize.add(GcmlPackage.eINSTANCE
					.getGcml_Activities());
			myFeaturesToSynchronize.add(GcmlPackage.eINSTANCE.getGcml_Person());
			myFeaturesToSynchronize.add(GcmlPackage.eINSTANCE
					.getGcml_IsAttached());
			myFeaturesToSynchronize.add(GcmlPackage.eINSTANCE
					.getGcml_Connection());
	...
	private Collection collectAllLinks(View view, Map domain2NotationMap) {
		if (!GcmlEditPart.MODEL_ID
				.equals(GcmlVisualIDRegistry.getModelID(view))) {
			return Collections.EMPTY_LIST;
		}
		...
		case GcmlEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(GcmlDiagramUpdater
						.getGcml_1000ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
		...
		case FormEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(GcmlDiagramUpdater
						.getForm_2002ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
		...
		case CallEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(GcmlDiagramUpdater
						.getCall_2004ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
		...
		case BoundaryEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(GcmlDiagramUpdater
						.getBoundary_2005ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
		...
		case PersonEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(GcmlDiagramUpdater
						.getPerson_2006ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
		...
		case IsAttachedEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(GcmlDiagramUpdater
						.getIsAttached_2007ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
		...
		case DecisionEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(GcmlDiagramUpdater
						.getDecision_2008ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
		...
		case ConnectionEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(GcmlDiagramUpdater
						.getConnection_2009ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
