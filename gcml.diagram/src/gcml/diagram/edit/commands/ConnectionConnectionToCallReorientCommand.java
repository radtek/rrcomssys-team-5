 ...
 * @generated
 */
public class ConnectionConnectionToCallReorientCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public ConnectionConnectionToCallReorientCommand(
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof Call && newEnd instanceof Connection)) {
			return false;
		}
		return GcmlBaseItemSemanticEditPolicy.LinkConstraints
				.canExistConnectionConnectionToCall_4007(getNewSource(),
						getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return GcmlBaseItemSemanticEditPolicy.LinkConstraints
				.canExistConnectionConnectionToCall_4007(getOldSource(),
						getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().setConnectionToCall(null);
		getNewSource().setConnectionToCall(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().setConnectionToCall(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
