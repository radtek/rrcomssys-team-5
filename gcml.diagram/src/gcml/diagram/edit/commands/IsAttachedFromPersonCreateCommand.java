 ...
 * @generated
 */
public class IsAttachedFromPersonCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public IsAttachedFromPersonCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return GcmlBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateIsAttachedFromPerson_4006(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().setFromPerson(getTarget());
		}
