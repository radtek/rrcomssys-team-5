 ...
 * @generated
 */
public class IsAttachedToDeviceCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public IsAttachedToDeviceCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return GcmlBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateIsAttachedToDevice_4002(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().setToDevice(getTarget());
		}
