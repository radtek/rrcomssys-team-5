...
public class GcmlSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case GcmlPackage.FORM: {
				Form form = (Form)theEObject;
				T result = caseForm(form);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GcmlPackage.WGCML: {
				wgcml wgcml = (wgcml)theEObject;
				T result = casewgcml(wgcml);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case GcmlPackage.ACTIVITY: {
				Activity activity = (Activity)theEObject;
				T result = caseActivity(activity);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GcmlPackage.BOUNDARY: {
				Boundary boundary = (Boundary)theEObject;
				T result = caseBoundary(boundary);
				if (result == null) result = caseActivity(boundary);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GcmlPackage.CALL: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>wgcml</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>wgcml</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casewgcml(wgcml object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Is Attached</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Is Attached</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseIsAttached(IsAttached object) {
		return null;
	}
