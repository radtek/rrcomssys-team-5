...
import gcml.diagram.edit.policies.DecisionCanonicalEditPolicy;
...
public class DecisionEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof DecisionSourceActivityIDEditPart) {
			((DecisionSourceActivityIDEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureDecisionSourceActivityIDFigure());
			return true;
		}
		if (childEditPart instanceof DecisionActivityIdEditPart) {
			((DecisionActivityIdEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureDecisionActivityIdFigure());
			return true;
		}
		if (childEditPart instanceof DecisionAlternatePathIDEditPart) {
			((DecisionAlternatePathIDEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureDecisionAlternatePathIDFigure());
			return true;
		}
		if (childEditPart instanceof DecisionSuccessPathIDEditPart) {
			((DecisionSuccessPathIDEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureDecisionSuccessPathIDFigure());
			return true;
		}
		if (childEditPart instanceof DecisionOutcomeEditPart) {
			((DecisionOutcomeEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureDecisionOutcomeFigure());
			return true;
		}
		return false;
	}
	...
	public class DecisionFigure extends RectangleFigure {
		 ...
		 * @generated
		 */
		private WrappingLabel fFigureDecisionAlternatePathIDFigure;
		/**
		 * @generated
		 */
		private WrappingLabel fFigureDecisionOutcomeFigure;
		...
		private void createContents() {
			...
			fFigureDecisionAlternatePathIDFigure = new WrappingLabel();
			fFigureDecisionAlternatePathIDFigure.setText("<...>");

			this.add(fFigureDecisionAlternatePathIDFigure);

			fFigureDecisionOutcomeFigure = new WrappingLabel();
			fFigureDecisionOutcomeFigure.setText("<...>");

			this.add(fFigureDecisionOutcomeFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureDecisionAlternatePathIDFigure() {
			return fFigureDecisionAlternatePathIDFigure;
		}

		/**
		 * @generated
		 */
		public WrappingLabel getFigureDecisionOutcomeFigure() {
			return fFigureDecisionOutcomeFigure;
		}
