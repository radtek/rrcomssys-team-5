 ...
 * @generated
 */
public class ConnectionFromDeviceCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ConnectionFromDeviceCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return WgcmlBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateConnectionFromDevice_4005(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getFromDevice().add(getTarget());
		}
