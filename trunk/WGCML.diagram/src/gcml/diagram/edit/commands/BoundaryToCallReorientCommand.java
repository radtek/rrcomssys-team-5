 ...
 * @generated
 */
public class BoundaryToCallReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public BoundaryToCallReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return WgcmlBaseItemSemanticEditPolicy.LinkConstraints
				.canExistBoundaryToCall_4015(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return WgcmlBaseItemSemanticEditPolicy.LinkConstraints
				.canExistBoundaryToCall_4015(getOldSource(), getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().setToCall(null);
		getNewSource().setToCall(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().setToCall(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
