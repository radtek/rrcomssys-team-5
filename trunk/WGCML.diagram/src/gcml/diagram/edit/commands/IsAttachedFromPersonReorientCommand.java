 ...
 * @generated
 */
public class IsAttachedFromPersonReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public IsAttachedFromPersonReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return WgcmlBaseItemSemanticEditPolicy.LinkConstraints
				.canExistIsAttachedFromPerson_4007(getNewSource(),
						getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return WgcmlBaseItemSemanticEditPolicy.LinkConstraints
				.canExistIsAttachedFromPerson_4007(getOldSource(),
						getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().setFromPerson(null);
		getNewSource().setFromPerson(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().setFromPerson(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
