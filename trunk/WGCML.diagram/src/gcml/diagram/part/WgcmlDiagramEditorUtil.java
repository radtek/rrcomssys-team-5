 ...
 * @generated
 */
public class WgcmlDiagramEditorUtil {
	...
	public static Resource openModel(Shell shell, String description,
		...
		try {
			...
			MessageDialog
					.openError(
							shell,
							Messages.WgcmlDiagramEditorUtil_OpenModelResourceErrorDialogTitle,
							NLS
									.bind(
											Messages.WgcmlDiagramEditorUtil_OpenModelResourceErrorDialogMessage,
											fileName));
		}
		return resource;
	}
	...
	public static void runWizard(Shell shell, Wizard wizard, String settingsKey) {
		IDialogSettings pluginDialogSettings = WgcmlDiagramEditorPlugin
	...
	public static Resource createDiagram(URI diagramURI, URI modelURI,
		...
		progressMonitor.beginTask(
				Messages.WgcmlDiagramEditorUtil_CreateDiagramProgressTask, 3);
		...
		AbstractTransactionalCommand command = new AbstractTransactionalCommand(
				editingDomain,
				Messages.WgcmlDiagramEditorUtil_CreateDiagramCommandLabel,
				Collections.EMPTY_LIST) {
			protected CommandResult doExecuteWithResult(
					IProgressMonitor monitor, IAdaptable info)
					throws ExecutionException {
				gcml.wgcml model = createInitialModel();
				...
				try {
					modelResource.save(gcml.diagram.part.WgcmlDiagramEditorUtil
							.getSaveOptions());
					diagramResource
							.save(gcml.diagram.part.WgcmlDiagramEditorUtil
									.getSaveOptions());
				} catch (IOException e) {
	 ...
	 * @generated
	 */
	private static gcml.wgcml createInitialModel() {
		return GcmlFactory.eINSTANCE.createwgcml();
	}
	 ...
	 * @generated
	 */
	private static void attachModelToResource(gcml.wgcml model,
			Resource resource) {
