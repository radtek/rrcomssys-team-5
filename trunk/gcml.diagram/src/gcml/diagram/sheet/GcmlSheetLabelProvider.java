 ...
 * @generated
 */
public class GcmlSheetLabelProvider extends DecoratingLabelProvider {

	/**
	 * @generated
	 */
	public GcmlSheetLabelProvider() {
		super(new AdapterFactoryLabelProvider(GcmlDiagramEditorPlugin
