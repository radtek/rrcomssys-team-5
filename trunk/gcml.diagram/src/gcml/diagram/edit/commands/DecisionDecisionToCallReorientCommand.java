 ...
 * @generated
 */
public class DecisionDecisionToCallReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public DecisionDecisionToCallReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return GcmlBaseItemSemanticEditPolicy.LinkConstraints
				.canExistDecisionDecisionToCall_4003(getNewSource(),
						getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return GcmlBaseItemSemanticEditPolicy.LinkConstraints
				.canExistDecisionDecisionToCall_4003(getOldSource(),
						getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getDecisionToCall().remove(getOldTarget());
		getNewSource().getDecisionToCall().add(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().getDecisionToCall().remove(getOldTarget());
		getOldSource().getDecisionToCall().add(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
