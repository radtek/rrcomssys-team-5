 ...
 * @generated
 */
public class GcmlDiagramEditorUtil {
	...
	public static Resource openModel(Shell shell, String description,
		...
		try {
			...
			MessageDialog
					.openError(
							shell,
							Messages.GcmlDiagramEditorUtil_OpenModelResourceErrorDialogTitle,
							NLS
									.bind(
											Messages.GcmlDiagramEditorUtil_OpenModelResourceErrorDialogMessage,
											fileName));
		}
		return resource;
	}
	...
	public static void runWizard(Shell shell, Wizard wizard, String settingsKey) {
		IDialogSettings pluginDialogSettings = GcmlDiagramEditorPlugin
	...
	public static Resource createDiagram(URI diagramURI, URI modelURI,
		...
		progressMonitor.beginTask(
				Messages.GcmlDiagramEditorUtil_CreateDiagramProgressTask, 3);
		...
		AbstractTransactionalCommand command = new AbstractTransactionalCommand(
				editingDomain,
				Messages.GcmlDiagramEditorUtil_CreateDiagramCommandLabel,
				Collections.EMPTY_LIST) {
			protected CommandResult doExecuteWithResult(
					IProgressMonitor monitor, IAdaptable info)
					throws ExecutionException {
				Gcml model = createInitialModel();
				...
				try {
					modelResource.save(gcml.diagram.part.GcmlDiagramEditorUtil
							.getSaveOptions());
					diagramResource
							.save(gcml.diagram.part.GcmlDiagramEditorUtil
									.getSaveOptions());
				} catch (IOException e) {
	 ...
	 * @generated
	 */
	private static Gcml createInitialModel() {
		return GcmlFactory.eINSTANCE.createGcml();
	}
	 ...
	 * @generated
	 */
	private static void attachModelToResource(Gcml model, Resource resource) {
